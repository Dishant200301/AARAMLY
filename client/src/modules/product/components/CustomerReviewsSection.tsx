...
const REVIEWS_DATA: Review[] = [
  {
    ...
    date: "July 18, 2026",
    verified: true,
    title: "Absolute game changer for everyday comfort!",
    comment:
      "I have bought so many bras over the years, but this Dimore Comfort Revolution bra is by far the softest. Wirefree yet offers incredible shape without side bulge. Super soft cotton elastane blend!",
    likes: 42,
    sizeBought: "36D",
  },
  {
    ...
    date: "July 12, 2026",
    verified: true,
    title: "Fits perfectly & doesn't dig into shoulders",
    comment:
      "The broad fabric straps make a huge difference. I wear it 10 hours at office and feel no pressure. Color is soft pink as shown in picture. Highly recommend!",
    likes: 28,
    sizeBought: "34B",
  },
  {
    ...
    date: "June 29, 2026",
    verified: true,
    title: "Great quality fabric and zero line visibility under t-shirts",
    comment:
      "Seamless finish works great under tight tees. Removable pads are easy to adjust after washing. Size chart was 100% accurate for me.",
    likes: 19,
    sizeBought: "38C",
  },
  {
    ...
    date: "June 15, 2026",
    verified: true,
    title: "Best seamless bra in India",
    comment:
      "Soft micro-knit nylon spandex material. Very breathable in summer. Fast 2-day delivery by Aaramly!",
    likes: 15,
    sizeBought: "32A",
  },
  {
    ...
    date: "June 02, 2026",
    verified: true,
    title: "Good support and gentle on skin",
    comment:
      "The fabric feels light and airy. Coverage is good and padding doesn't shift easily during washes.",
    likes: 11,
    sizeBought: "34C",
  },
  {
    ...
    date: "May 20, 2026",
    verified: true,
    title: "Decent comfort, but size runs slightly snug",
    comment:
      "Fabric is super soft, but band felt a bit tighter than expected. Would recommend sizing up if between sizes.",
    likes: 8,
    sizeBought: "36B",
  },
];
