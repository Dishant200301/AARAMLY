...
export default function NewsletterCTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-16 md:py-20 lg:py-24 text-zinc-900 border-t border-b border-zinc-200/80">
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center lg:grid lg:grid-cols-12 lg:items-center lg:gap-12 lg:text-left">
          ...
          <div className="lg:col-span-6 max-w-2xl">
            <span className="text-[12px] font-extrabold tracking-[0.25em] text-[#80a17d] block mb-2">
              JOIN THE CLUB
            </span>
          ...
          <div className="w-full lg:col-span-6 mt-8 lg:mt-0 max-w-xl lg:ml-auto">
            <form onSubmit={handleSubscribe} className="w-full">
              <div className="flex items-stretch border border-zinc-300 bg-zinc-50 rounded-lg overflow-hidden focus-within:border-[#80a17d] focus-within:bg-white transition-colors shadow-xs">
                <input
                  type="email"
                  required
