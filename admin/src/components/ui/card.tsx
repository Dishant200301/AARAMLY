...
>(({ className = "", ...props }, ref) => (
  <div
    ref={ref}
    className={`rounded-xl border border-neutral-200 bg-white text-zinc-950 shadow-2xs ${className}`}
    {...props}
  />
))
...
>(({ className = "", ...props }, ref) => (
  <h3
    ref={ref}
    className={`font-semibold leading-none tracking-tight text-black ${className}`}
    {...props}
  />
))
