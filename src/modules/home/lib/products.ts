...
export const PRODUCTS: Product[] = [
  ...
  // PANTIES
  { id: "p5", name: "Seamless | Mid Rise | Ultra Stretch | Brief Panty", price: 299, rating: 4.5, img: IMG.seamless[0], hoverImg: IMG.seamless[1], colors: ["#111", "#eadfd3", "#c8a48c"], sizes: ["S", "M", "L"], category: "panties", tags: ["Seamless Panty", "Everyday Brief"] },
  { id: "p6", name: "Lace Trim | Low Rise | Soft Microfibre | Hipster", price: 349, rating: 4.6, img: IMG.seamless[1], hoverImg: IMG.seamless[2], colors: ["#e8c9a8", "#000"], sizes: ["M", "L", "XL"], category: "panties", tags: ["Lace Trim", "Comfort Fit Hipster"] },
  { id: "p7", name: "Ultra-Grip | High Waisted | Shaping | Seamless Brief", price: 399, rating: 4.5, img: IMG.seamless[2], hoverImg: IMG.seamless[3], colors: ["#c9b8a5", "#111"], sizes: ["S", "M", "L", "XL"], category: "panties", tags: ["High Waisted Brief", "Shaping Effect"] },
  ...
  { id: "p9", name: "Activewear | Ribbed Bralette & Shorts | Lounge Set", price: 1199, rating: 4.6, img: IMG.bralette[1], hoverImg: IMG.bralette[2], colors: ["#c8a48c", "#111"], sizes: ["S", "M", "L"], category: "sets", tags: ["Ribbed Knit", "All-Day Loungewear"] },
  ...
  // NIGHT WEAR
  { id: "p13", name: "Soft Satin | Strappy Neck | Luxury Slip Dress", price: 1299, rating: 4.8, img: IMG.bralette[2], hoverImg: IMG.seamless[1], colors: ["#111", "#c9b8a5"], sizes: ["S", "M", "L"], category: "nightwear", tags: ["Satin Silk", "Luxury Loungewear"] },
  { id: "p14", name: "Ribbed Modal | Loose Fit | Cozy Pajama Set", price: 1499, rating: 4.7, img: IMG.bralette[0], hoverImg: IMG.seamless[0], colors: ["#d8c1a8", "#111"], sizes: ["M", "L", "XL"], category: "nightwear", tags: ["Ribbed Modal", "Cozy Sleep Set"] },
];
